...
public class DBDetails {
	...
	static String MOBILE_COL="MOBILE";
	static String COLLEGE_COL="COLLEGE";
	static String QUALIFICATION_COL="QUALIFICATION";
	static String STREAM_COL="STREAM";
	static String PERCENTAGE_COL="PERCENTAGE";
	static String CLOCATION_COL="CLOCATION";
	static String ADDRESS_COL="ADDRESS";
	static String PINCODE_COL="PINCODE";
	static String PASSOUT_COL="PASSOUT";
